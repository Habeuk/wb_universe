...
class Theme {
  ...
  public function add_button($name, $group, $form, $title = 'Button') {
    ...
    $form[$group . $name . 'group'][$group . $name] = [
      '#type' => 'textfield',
      '#title' => t('text bouton'),
      '#default_value' => theme_get_setting($group . $name, 'wb_universe')
    ];
    // link
    $form[$group . $name . 'group'][$group . $name . 'url'] = [
      '#type' => 'textfield',
      '#title' => t('URL '),
      '#default_value' => theme_get_setting($group . $name . 'url', 'wb_universe')
    ];
    // class or attribute
    $form[$group . $name . 'group'][$group . $name . 'class'] = [
      '#type' => 'select',
      '#title' => t('Class '),
      '#default_value' => theme_get_setting($group . $name . 'class', 'wb_universe'),
  ...
  public function add_textfield($name, $group, $form, $title = 'title', $default = '') {
    $value = theme_get_setting($group . $name, 'wb_universe');
    // text
    $form[$group . $name] = [
      '#type' => 'textfield',
      '#title' => t($title),
  ...
  public function load_images() {
    ...
    $query->condition("module", 'wb_universe');
